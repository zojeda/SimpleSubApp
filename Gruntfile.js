module.exports = function(grunt) {
    ...
    var fileConfig = {
        ...
        app_files: {
            ...
            componentTemplates: [ 'src/**/*.tpl.html' ],
        ...
        vendor_files: {
            js: [
                ...
                'vendor/uiSkeleton/component/uiSkeleton-0.0.1.js',
    ...
    grunt.registerTask('compile-component', [
        'less:compile', 'concat:compile_component_js', 'copy:compile_component_assets', 'index:compile'
    ]);
